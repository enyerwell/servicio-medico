...
class PDF extends FPDF{
    ...
    $this->CELL(75,5,'Medicamento',1,0,'C',0 );
    $this->CELL(30,5,'Cantidad',1,0,'C',0 );
    $this->CELL(40,5,'Registrado por ',1,0,'C',0 );
    $this->CELL(60,5,'Hora y Fecha ',1,0,'C',0 );
